...
We hope this guide has helped make things a little clearer during what is undoubtedly an overwhelming time. If you have any questions about funeral costs more broadly, our team at funeralpricing.co.uk is here to help.
  ...
  },
  {
    ...
    excerpt:
      "Funeral costs in the UK have risen significantly over the past decade. Here's what you need to know about pricing and how to plan ahead.",
    date: "2026-02-17",
    content: `
Funeral costs in the UK have risen significantly over the past decade, with the average funeral now costing between £3,000 and £5,000. Understanding what drives these costs can help families make informed decisions during a difficult time.
...
- **Coffin or casket** — Prices vary enormously, from simple cardboard or willow coffins at around £100–£300 to high-end hardwood caskets costing several thousand pounds.
- **Cremation or burial fees** — Cremation fees vary by crematorium but typically range from £300 to £1,000. Burial plots can cost anywhere from £500 to over £5,000 depending on location.
- **Doctor's fees** — Two doctors must sign cremation certificates, which costs around £160 in total (though this is being phased out under reforms).
- **Church or ceremony fees** — If you choose a religious service, there are set fees for the church and officiant.

## Direct cremation: the affordable alternative

Direct cremation has grown in popularity as a simpler, more affordable option. With a direct cremation, there is no funeral service — the cremation takes place without mourners present, and the ashes are returned to the family.

Direct cremation prices typically range from **£1,000 to £1,500**, making it significantly cheaper than a traditional funeral. Families can then choose to hold a separate memorial or celebration of life on their own terms.

## How to compare prices

Funeral directors are now required to display a Standardised Price List, making it easier to compare costs. When comparing, make sure you're looking at:

1. The total cost, not just the funeral director's fees
2. What's included and what's extra
3. Whether disbursements (third-party costs) are included in the quote
...
We're building funeralpricing.co.uk to help you compare direct cremation prices across the UK, so you can find the right option for your family.
    `.trim(),
  },
  {
...
Don't feel pressured to choose the first funeral director you contact. It's perfectly acceptable to get quotes from two or three providers and compare. At funeralpricing.co.uk, we're building a tool to make this comparison easier, helping you find the right funeral director at a fair price.
    `.trim(),
  },
];
